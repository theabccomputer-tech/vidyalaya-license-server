...
def admin_panel():
    ...
    for lic in all_licenses:
        ...
        <tr style="border-bottom:1px solid #eee">
          ...
          <td style="padding:10px;font-family:monospace;font-size:.75rem">
            <span onclick="navigator.clipboard.writeText('{lic.key}');this.style.color='#10b981';this.title='Copied!'"
              style="cursor:pointer;color:#6c63ff;word-break:break-all" title="Click to copy">
              {lic.key}
            </span>
          </td>
    ...
    <div class="container">
      ...
      <div class="section">
        ...
        <p style="font-size:.75rem;color:#999;margin-top:8px">💡 Key pe click karo — copy ho jaayegi</p>
      </div>
...
def admin_create_license():
    ...
    form         = request.form
    school_name  = form['school_name'].strip()
    school_city  = form['school_city'].strip()
    max_students = int(form.get('max_students', 500))
    days_valid   = int(form.get('days_valid', 365))
